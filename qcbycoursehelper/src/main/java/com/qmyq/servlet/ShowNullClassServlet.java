...
/**
 * Servlet implementation class ShowNullClassServlet
 */
@WebServlet("/ShowNullClassServlet")
public class ShowNullClassServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShowNullClassServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.setContentType("application/json; charset=utf-8");
			...
			System.out.println(pageIndex+" "+pageSize+" "+classString);
